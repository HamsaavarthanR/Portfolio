...
const projects = [
    ...
    },
    {
        ...
        vid_src: "videos/5_Berlin.mp4",
        // Project Info Box
        title: '<span class="gradient">BERLIN</span> - The Autonomous Robot',
        descrition: "Engineered a fully autonomous robot achieving Level 4 autonomy, leveraging advanced modeling and controls, perception systems, localization, SLAM algorithms, planning, and decision-making processes.<br/><br/>Developed real-time control systems on Raspberry Pi via SSH communication to manage encoders, actuators, cameras, servo motors, DC motors, and IMU sensors. Achieved sensor fusion using Server-Client protocol with near ~100% autonomy.<br/><br/>Optimized motion control accuracy (98%) using PID closed-loop feedback systems, applying industrial troubleshooting methods for hardware and software integration challenges.",
        // Technologies (FILTER)
    ...
    },
    {
        ...
        vid_src: "videos/6_Homography.mp4",
        // Project Info Box
        ...
        projectsGrid.innerHTML = projectsToRender.map(project => `
            <div class="project-card">
                <div class="project-vidbox">
                    <video id="${project.vid_id}" src="${project.vid_src}"></video>
                </div>
...
document.getElementById("viewResume").addEventListener("click", function() {
    window.location.href = "https://github.com/HamsaavarthanR/Profile/blob/main/Resume.pdf"; // Replace with actual GitHub file URL
});
